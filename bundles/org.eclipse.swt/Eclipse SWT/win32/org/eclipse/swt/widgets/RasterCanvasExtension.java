...
public abstract class RasterCanvasExtension implements Listener, IExternalCanvasHandler {
		...
		@Override
		public Object paint(PaintEventSender s, long wParam, long lParam) {
			...
			long result = canvas.callWindowProc (canvas.handle, OS.WM_PAINT, wParam, lParam);
