...
//						System.out.println("ICO: " + f.getName());
//						System.out.println("  width=" + data.width + " height=" + data.height + " depth=" + data.depth);
//						System.out.println("  palette.isDirect=" + data.palette.isDirect);
//						System.out.println("  transparencyType=" + data.getTransparencyType());
//						System.out.println("  alphaData=" + (data.alphaData != null ? data.alphaData.length : "null"));
//						System.out.println("  maskData=" + (data.maskData != null ? data.maskData.length : "null"));
//						System.out.println("  transparentPixel=" + data.transparentPixel);
//						if (data.maskData != null && data.maskData.length > 0) {
//							System.out.print("  maskData sample: ");
//							for (int i = 0; i <  data.maskData.length; i++) {
//								System.out.print(String.format("%02X ", data.maskData[i]));
//							}
//							System.out.println();
//						}
					} catch (Exception e) {
