...
public class Test_org_eclipse_swt_skia_drawOval {
	...
	public void testDrawOval() {
		...
		assertEquals(MethodCall.get("surface-canvas", "drawOval", new Rect(10.5f, 20.5f, 40.5f, 60.5f), epd),
				surface.calls.get(0));
	...
	@Test
	public void testDrawOval_Zoom150() {
		...
		// Rect: left=15.75, top=30.75, right=15+45.75=60.75, bottom=30+60.75=90.75
		assertEquals(MethodCall.get("surface-canvas", "drawOval", new Rect(15.75f, 30.75f, 60.75f, 90.75f), epd),
				surface.calls.get(0));
