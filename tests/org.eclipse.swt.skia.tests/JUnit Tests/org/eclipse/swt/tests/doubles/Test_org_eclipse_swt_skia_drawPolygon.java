...
public class Test_org_eclipse_swt_skia_drawPolygon {
	@BeforeAll
	...
	public void testDrawPolygon() {
		...
		// drawPolygon creates a drawPath call with the polygon path
		assertEquals("drawPath", canvas.calls.get(0).methodName);
