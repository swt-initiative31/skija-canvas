...
public class Test_org_eclipse_swt_skia_drawText_NoCache {
	...
	public void testDrawText() {
		...
		// FontData validation
		org.eclipse.swt.tests.doubles.FontData fontData = (org.eclipse.swt.tests.doubles.FontData) secondCall.params[3];
	...
	public void testDrawText_Zoom150() {
		...
		Rect rectParam = (Rect) firstCall.params[0];
		// At 150% zoom: 10*1.5=15, 20*1.5=30, right=44*1.5=66, bottom=35*1.5=52.5
		...
		assertEquals(66.0f, rectParam.getRight(), 0.1f, "Rectangle right should be 66.0");
		assertEquals(52.5f, rectParam.getBottom(), 0.1f, "Rectangle bottom should be 52.5");
		...
		assertEquals("drawString", secondCall.methodName, "Second call should be drawString");
		assertEquals("World", secondCall.params[0], "Text parameter should be 'World'");
		// At 150% zoom: x=10*1.5=15, y=20*1.5=30 + offset
		assertEquals(15, secondCall.params[1], "X position should be 15 (10*1.5)");
		assertEquals(46, secondCall.params[2], "Y position should be ~46 (estimated)");
