...
public class Test_org_eclipse_swt_skia_RGBAEncoder {
    ...
    public void testIndexed8BitNoTransparency() {
        ...
        PaletteData palette = new PaletteData(new RGB(255,0,0), new RGB(0,255,0), new RGB(0,0,255));
        byte[] data = {0, 1, 2, 0}; // 2x2: R G
                                    //      B R
        ImageData img = new ImageData(2, 2, 8, palette, 1, data);
        byte[] rgba = RGBAEncoder.encode(img);
    ...
    public void testIndexed8BitTransparentPixel() {
        ...
        PaletteData palette = new PaletteData(new RGB(1,2,3), new RGB(4,5,6));
        byte[] data = {0, 1, 0, 1};
        ImageData img = new ImageData(2, 2, 8, palette, 1, data);
    ...
    public void testIndexed8BitAlphaData() {
        ...
        PaletteData palette = new PaletteData(new RGB(10,20,30), new RGB(40,50,60));
        byte[] data = {0, 1, 0, 1};
        ImageData img = new ImageData(2, 2, 8, palette, 1, data);
    ...
    public void testDirect24BitNoTransparency() {
        ...
        ImageData img = new ImageData(2, 2, 24, palette, 1, data);
    ...
    public void testIndexed1BitNoTransparency() {
        ...
        byte[] data = {(byte)0b00000000, (byte)0b01000000}; // Row 1: 0 0, Row 2: 0 1
        ImageData img = new ImageData(2, 2, 1, palette, 1, data);
        byte[] rgba = RGBAEncoder.encode(img);
        // Check RGBA values for each pixel
    ...
    public void testIndexed4BitNoTransparency() {
        ...
        byte[] data = {(byte)0x12, (byte)0x34}; // 2x2: 1 2
                                              //      3 4
        ImageData img = new ImageData(2, 2, 4, palette, 1, data);
